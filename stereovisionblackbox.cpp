...
bool StereoVisionBlackBox::calibrateCameras()
{
    ...
    for (uint i = 0; i < calibImgsLeft.size(); ++i)
    {
        ...
        if(success1 && success2)
        {
            ...
            objPoints1.push_back(obj);
            objPoints2.push_back(obj);
        }
    }
    ...
    calibrateCamera(objPoints1, imgPoints1, imgSz, camMat1, distCoeff1, rvecs1, tvecs1);
    calibrateCamera(objPoints2, imgPoints2, imgSz, camMat2, distCoeff2, rvecs2, tvecs2);
